...
namespace XamProjectTemplate
{
    ...
    {
        public static readonly BindableProperty ComboBoxViewProperty = BindableProperty.Create(nameof(ComboBoxView), typeof(ComboBox), typeof(ComboBoxListPopup), null);

        public ComboBox ComboBoxView
        {
            get { return (ComboBox)GetValue(ComboBoxViewProperty); }
        ...
        public ComboBoxListPopup(ComboBox visualElement, double widthSet, double heightSet)
        {
            InitializeComponent();
