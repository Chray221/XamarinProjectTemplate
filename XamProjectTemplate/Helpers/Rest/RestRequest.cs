...
using XamProjectTemplate.Helpers;
using ImTools;
                    ...
                    if (Connectivity.NetworkAccess == NetworkAccess.Internet)
                    {
                        var handler = new TimeoutHandler
                        {
                            ...
                            InnerHandler = new HttpClientHandler()
                            {
                                ...
                                {
                                    //byXamProjectTemplate to ignore ssl certificate
                                    return true;
                                }
                            }
                        };
...
// NOTE
// server side changes:
//   override devise-token-auth response if unauthorize error, see XamProjectTemplate-rails source code
